...
#SBATCH --output=/home/ruism/projects/def-rsdjjana/ruism/Dreamer_v2_AEH/results/reacherloca_v2_state_ae_10seeds/%A-%a.out
#SBATCH --error=/home/ruism/projects/def-rsdjjana/ruism/Dreamer_v2_AEH/results/reacherloca_v2_state_ae_10seeds/%A-%a.err

set -e -o pipefail

# Top-level results dir on Lustre
BASE_SAVE_DIR="$HOME/projects/def-rsdjjana/ruism/Dreamer_v2_AEH/results/reacherloca_v2_state_ae_10seeds"
...
python -u "$DREAMER_SRC/dreamer.py" \
  ...
  --algo Dreamerv2 \
  --exp-name reacherloca_v2_state_ae_10seeds \
  --train \
  --loca-all-phases \
  --buffer-size 2500000 \
